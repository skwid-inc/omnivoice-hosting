...
class StepScheduler(_BaseScheduler):
    ...
    def update_from_output(self, sched_output: DiffusionSchedulerOutput, output: RunnerOutput) -> set[str]:
        ...
        per_request_results = output.per_request_results or {}
        per_request_finished = output.per_request_finished or {}
        per_request_step_indices = output.per_request_step_indices or {}
